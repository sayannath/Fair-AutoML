...
a_file = open("compas_mlp_aod_race_60sp" + str(now) + ".pkl", "wb")
pickle.dump(automl.cv_results_, a_file)
a_file.close()

a_file1 = open("automl_compas_mlp_aod_race_60sp" + str(now) + ".pkl", "wb")
...
write_file(
    "./run_history/compas_mlp_aod_race_run_history.json",
