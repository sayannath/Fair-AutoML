...
now = now.replace(":", "_")
temp_path = "compas_lrg_di" + str(now)
try:
...
automl = autosklearn.classification.AutoSklearnClassifier(
    ...
    ensemble_size=1,
    include_preprocessors=['extra_trees_preproc_for_classification', 'nystroem_sampler',
...
# ===================================
a_file = open("compas_lrg_di_60sp" + str(now) + ".pkl", "wb")
pickle.dump(automl.cv_results_, a_file)
a_file.close()

a_file1 = open("automl_compas_lrg_di_60sp" + str(now) + ".pkl", "wb")
