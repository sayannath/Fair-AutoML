...
create_dir("titanic_xgb_di_results")
...
def accuracy(solution, prediction):
    ...
    write_file(
        "./titanic_xgb_di_results/titanic_xgb_score.txt",
...
write_file(
    "./titanic_xgb_di_results/automl_models.json",
...
write_file("./titanic_xgb_di_results/best_model_cost.txt", str(best_model_cost))
...
write_file(
    "./titanic_xgb_di_results/titanic_xgb_spd_models.json",
...
write_file(
    "./titanic_xgb_di_results/accuracy_fairness_score.txt",
...
write_file("./titanic_xgb_di_results/classification_report.txt", str(cr))
write_file("./titanic_xgb_di_results/confusion_matrix.txt", str(cm))
...
log_artifact("titanic_xgb_di_results", "titanic_xgb_di_60sp")
