...
class CustomSVC(AutoSklearnClassificationAlgorithm):
    ...
    def get_hyperparameter_search_space(dataset_properties=None):
        C = UniformFloatHyperparameter(
            "C", 0.04717, 11335, log=True, default_value=0.85
        )
        ...
        gamma = UniformFloatHyperparameter(
            "gamma", 3.1466158232736585e-05, 0.95334, log=True, default_value=0.1
        )
        # TODO this is totally ad-hoc
        coef0 = UniformFloatHyperparameter(
            "coef0", -0.59878, 0.51839, default_value=0.0
        )
        ...
        tol = UniformFloatHyperparameter(
            "tol", 1.2507352751797604e-05, 0.02704, default_value=1e-3, log=True
        )
...
write_file(
    "./run_history/german_svc_eod_age_run_history.json",
