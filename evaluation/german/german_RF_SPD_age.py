...
now = now.replace(":", "_")
temp_path = "german_rf_spd" + str(now)
try:
...
class CustomRandomForest(AutoSklearnClassificationAlgorithm):
    ...
    def get_hyperparameter_search_space(dataset_properties=None):
        ...
        n_estimators = UniformIntegerHyperparameter(
            "n_estimators", 211, 735, default_value=211
        )
...
a_file = open("german_rf_spd" + str(now) + "60sp.pkl", "wb")
pickle.dump(automl.cv_results_, a_file)
a_file.close()

a_file1 = open("automl_german_rf_spd" + str(now) + "60sp.pkl", "wb")
...
write_file(
    "./run_history/german_rf_spd_age_run_history.json",
