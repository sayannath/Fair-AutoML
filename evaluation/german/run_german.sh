...
python german_RF_SPD_age.py >> ./training_logs/german_RF_SPD_age.txt # 21:50
...
python german_RF_AOD_sex.py >> ./training_logs/german_RF_AOD_sex.txt # 2:50
...
python german_LRG_EOD_age.py >> ./training_logs/german_LRG_EOD_age.txt # 3:50
...
python german_MLP_EOD_age.py >> ./training_logs/german_MLP_EOD_age.txt # 9:50
