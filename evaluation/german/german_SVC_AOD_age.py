...
class CustomSVC(AutoSklearnClassificationAlgorithm):
    ...
    def get_hyperparameter_search_space(dataset_properties=None):
        C = UniformFloatHyperparameter(
            "C", 0.06199, 10899, log=True, default_value=0.85
        )
        ...
        gamma = UniformFloatHyperparameter(
            "gamma", 3.623464265765924e-05, 2.09810, log=True, default_value=0.1
        )
        # TODO this is totally ad-hoc
        coef0 = UniformFloatHyperparameter(
            "coef0", -0.24177, 0.73406, default_value=0.0
        )
        ...
        tol = UniformFloatHyperparameter(
            "tol", 1.25e-5, 0.03287, default_value=1e-3, log=True
        )
...
write_file(
    "./run_history/german_svc_aod_age_run_history.json",
