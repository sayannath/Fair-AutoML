...
class CustomSVC(AutoSklearnClassificationAlgorithm):
    ...
    def get_hyperparameter_search_space(dataset_properties=None):
        C = UniformFloatHyperparameter("C", 0.03833, 7706, log=True, default_value=0.85)
        ...
        gamma = UniformFloatHyperparameter(
            "gamma", 3.623464265765924e-05, 1.083, log=True, default_value=0.1
        )
        # TODO this is totally ad-hoc
        coef0 = UniformFloatHyperparameter(
            "coef0", -0.40253, 0.51697, default_value=0.0
        )
        ...
        tol = UniformFloatHyperparameter(
            "tol", 1.0525339408630472e-05, 0.01857, default_value=1e-3, log=True
        )
