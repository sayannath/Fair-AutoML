...
a_file = open("german_mlp_aod_age_60sp" + str(now) + ".pkl", "wb")
pickle.dump(automl.cv_results_, a_file)
a_file.close()

a_file1 = open("automl_german_mlp_aod_age_60sp" + str(now) + ".pkl", "wb")
...
write_file(
    "./run_history/german_mlp_aod_age_run_history.json",
