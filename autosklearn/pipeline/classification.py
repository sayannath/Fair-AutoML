...
from autosklearn.pipeline.components.data_preprocessing.data_preprocessing import (
    DataPreprocessor,
)
from autosklearn.pipeline.components import classification as classification_components
        ...
        for c, f in product(classifiers_, feature_learning):
            ...
            while True:
                try:
                    ...
                    cs.get_hyperparameter("classifier:__choice__").default_value = (
                        default
                    )
